...
// Vars for vertical scrolling 
#define TOP_SCREEN false
#define BOTTOM_SCREEN true
#define DROP_IN true
#define DROP_OUT true
#define FLY_IN true
#define FLY_OUT false
#define RAISE_UP false
...
boolean jumpTextVertical(int x,boolean screenHalf, boolean isDropping, boolean flyIn, char Str1[ ], byte txtSize, byte color, int delaytime);
