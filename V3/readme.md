While there's no release date for Xronos 3 clock (I need financing to do a run of new LED displays), I rewrote most of the code and it's now compatible with Xronos V2!
